            ...
            if form.is_valid():
                ...
                if user is not None:
                    if check_password(password, user.password):
                        ...
                        return render(request, "accounts/Delete_account.html", context={"form": form, "msg": msg, "user": user})
            else:
                user = getUser(request)
                return render(request, "accounts/Delete_account.html", context={"form": form, "user": user})
        else:
