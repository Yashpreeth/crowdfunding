...
urlpatterns = [
    ...
    path('project-details/<int:id>/', views.show_project_details, name='project_details'),
    path('projects/', views.all_projects, name='all_projects'),    
    path('project-details/<int:project_id>/rate/', views.rate, name='rate'),
    path('projects/category/<int:category_id>/', views.get_category_projects, name='get_category_projects'),
]

# Add this line to include static files
